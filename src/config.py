...
def load_config() -> AppConfig:
	...
	data_paths = PathsConfig(
		...
		data_processed=_ensure_path(paths_section.get("data_processed", "data/processed")),
	...
	mlflow_tracking_uri = _ensure_path(env_settings.mlflow_tracking_uri or mlflow_section.get("tracking_uri", "mlruns"))
	...
	return AppConfig(
		...
		mlflow=MLflowConfig(
			...
			experiment_name=mlflow_section.get("experiment_name", "walmart-weekly-sales"),
		),
