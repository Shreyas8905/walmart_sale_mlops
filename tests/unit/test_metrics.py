...
from src.evaluation.metrics import compute_all_metrics, mae, mape, r2, rmse, select_champion
...
def test_select_champion_minimize_and_maximize():
	...
	assert select_champion(results, metric="rmse", direction="minimize")["model_name"] == "b"
	assert select_champion(results, metric="r2", direction="maximize")["model_name"] == "a"
